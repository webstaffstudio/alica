<div <?php anahata_mikado_class_attribute($process_item_classes); ?>>
    <?php if($link != '') { ?>
        <a href="<?php echo esc_url($link); ?>" target="<?php esc_attr($target);  ?>"></a>
    <?php } ?>
    <div class="mkd-pi-front">
        <div class="mkd-pi-holder-inner" <?php anahata_mikado_inline_style($process_item_styles); ?>>

            <?php if(!empty($number)) : ?>
                <div class="mkd-number-holder-inner" <?php anahata_mikado_inline_style($process_number_style); ?>>
            ...
            <div class="mkd-pi-content-holder">
                <?php if(!empty($title)) : ?>
                    <div class="mkd-pi-title-holder">
                        <h4 class="mkd-pi-title" <?php echo anahata_mikado_inline_style('color: '.$title_color);  ?>><?php echo esc_html($title); ?></h4>
                    </div>
                <?php endif; ?>
    ...
    <?php if ($flip_on_hover == 'yes') { ?>
        <div class="mkd-pi-back" <?php anahata_mikado_inline_style($process_item_back_side_styles); ?>>
