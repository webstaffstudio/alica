...
<span class="mkd-accordion-mark mkd-left-mark">
		<span class="mkd-accordion-mark-icon">
			<span class="mkd-carousel-arrow-down"> <?php echo anahata_mikado_icon_collections()->renderIcon('arrow_carrot-down', 'font_elegant'); ?></span>
			<span class="mkd-carousel-arrow-up"> <?php echo anahata_mikado_icon_collections()->renderIcon('arrow_carrot-up', 'font_elegant'); ?></span>
		</span>
</span>
<span class="mkd-tab-title">
		<span class="mkd-tab-title-inner">
			...
			<?php if($params['number']) : ?>
				<span class="mkd-accordion-number" <?php anahata_mikado_inline_style($color_number)?>><?php echo esc_attr($number) ?></span>
			<?php endif; ?>
