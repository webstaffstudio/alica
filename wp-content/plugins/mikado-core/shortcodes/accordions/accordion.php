<?php
namespace Anahata\Modules\Accordion;
...
class Accordion implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                    => esc_html__('Accordion', 'mikado-core'),
            'base'                    => $this->base,
            ...
            'params'                  => array(
                ...
                array(
                    ...
                    'value'       => array(
                        ...
                        esc_html__('Boxed Accordion', 'mikado-core') => 'boxed_accordion',
                        esc_html__('Toggle', 'mikado-core')          => 'toggle',
                        esc_html__('Boxed Toggle', 'mikado-core')    => 'boxed_toggle'
                    ),
                    'save_always' => true,
                    'description' => ''
                )
