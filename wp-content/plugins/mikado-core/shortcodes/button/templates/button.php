<button type="submit" <?php anahata_mikado_class_attribute($button_classes); ?> <?php echo anahata_mikado_get_inline_attrs($button_data); ?> <?php anahata_mikado_inline_style($button_styles); ?> <?php echo anahata_mikado_get_inline_attrs($button_custom_attrs); ?>>
