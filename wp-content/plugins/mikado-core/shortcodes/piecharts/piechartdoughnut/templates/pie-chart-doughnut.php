<div class="mkd-pie-chart-doughnut-holder">
	<div class="mkd-pie-chart-doughnut">
		<canvas id="pie<?php echo esc_attr($id); ?>" class="mkd-doughnut" height="<?php echo esc_attr($height); ?>" width="<?php echo esc_attr($width); ?>" <?php echo anahata_mikado_get_inline_attrs($pie_chart_data)?>></canvas>
	</div>
