...
class HeaderStandardExtended extends HeaderType {
	...
	public function __construct() {
		...
		if(!is_admin()) {
            ...
            $logoAreaHeight       = anahata_mikado_filter_px(anahata_mikado_options()->getOptionValue('logo_area_height_header_standard_extended'));
            $this->logoAreaHeight = $logoAreaHeight !== '' ? intval($logoAreaHeight) : 155;

			$menuAreaHeight       = anahata_mikado_filter_px(anahata_mikado_options()->getOptionValue('menu_area_height_header_standard_extended'));
	...
	public function headerPerPageStyles($style) {
        ...
        $disable_logo_border = anahata_mikado_get_meta_field_intersect('logo_area_border_header_standard_extended',$id) == 'no';
        $disable_logo_grid_border = anahata_mikado_get_meta_field_intersect('logo_area_in_grid_border_header_standard_extended',$id) == 'no';

        $disable_menu_border = anahata_mikado_get_meta_field_intersect('menu_area_border_header_standard_extended',$id) == 'no';
        $disable_menu_grid_border = anahata_mikado_get_meta_field_intersect('menu_area_in_grid_border_header_standard_extended',$id) == 'no';
        ...
        $logo_area_background_color_rgba = anahata_mikado_rgba_color($logo_area_background_color, $logo_area_background_transparency);
        ...
        $logo_area_grid_background_color_rgba = anahata_mikado_rgba_color($logo_area_grid_background_color, $logo_area_grid_background_transparency);
        ...
        $style[] = anahata_mikado_dynamic_css($logo_area_selector, $logo_area_style);
        $style[] = anahata_mikado_dynamic_css($logo_area_grid_selector, $logo_area_grid_style);
	...
	public function loadTemplate($parameters = array()) {
        ...
        $parameters['logo_area_in_grid'] = anahata_mikado_get_meta_field_intersect('logo_area_in_grid_header_standard_extended',$id) == 'yes' ? true : false;
        $parameters['menu_area_in_grid'] = anahata_mikado_get_meta_field_intersect('menu_area_in_grid_header_standard_extended',$id) == 'yes' ? true : false;

		$parameters = apply_filters('anahata_mikado_header_standard_extended_parameters', $parameters);
	...
	public function calculateHeightOfTransparency() {
        ...
        } elseif(anahata_mikado_options()->getOptionValue('logo_area_background_color_header_standard_extended') == '') {
            $logoAreaTransparent = anahata_mikado_options()->getOptionValue('logo_area_grid_background_color_header_standard_extended') !== '' &&
                anahata_mikado_options()->getOptionValue('logo_area_grid_background_transparency_header_standard_extended') !== '1';
        } else {
            $logoAreaTransparent = anahata_mikado_options()->getOptionValue('logo_area_background_color_header_standard_extended') !== '' &&
                anahata_mikado_options()->getOptionValue('logo_area_background_transparency_header_standard_extended') !== '1';
        }
		...
		} elseif(anahata_mikado_options()->getOptionValue('menu_area_background_color_header_standard_extended') == '') {
			$menuAreaTransparent = anahata_mikado_options()->getOptionValue('menu_area_grid_background_color_header_standard_extended') !== '' &&
			                       anahata_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_standard_extended') !== '1';
		} else {
			$menuAreaTransparent = anahata_mikado_options()->getOptionValue('menu_area_background_color_header_standard_extended') !== '' &&
			                       anahata_mikado_options()->getOptionValue('menu_area_background_transparency_header_standard_extended') !== '1';
		}
	...
	public function calculateHeightOfCompleteTransparency() {
        ...
        if(get_post_meta($id, 'mkd_logo_area_background_color_header_standard_extended_meta', true) !== '') {
            ...
            $logoAreaTransparent = anahata_mikado_options()->getOptionValue('logo_area_grid_background_color_header_standard_extended') !== '' &&
                anahata_mikado_options()->getOptionValue('logo_area_grid_background_transparency_header_standard_extended') === '0';
        } else {
            $logoAreaTransparent = anahata_mikado_options()->getOptionValue('logo_area_background_color_header_standard_extended') !== '' &&
                anahata_mikado_options()->getOptionValue('logo_area_background_transparency_header_standard_extended') === '0';
        }
		...
		if(get_post_meta($id, 'mkd_menu_area_background_color_header_standard_extended_meta', true) !== '') {
			...
			$menuAreaTransparent = anahata_mikado_options()->getOptionValue('menu_area_grid_background_color_header_standard_extended') !== '' &&
			                       anahata_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_standard_extended') === '0';
		} else {
			$menuAreaTransparent = anahata_mikado_options()->getOptionValue('menu_area_background_color_header_standard_extended') !== '' &&
			                       anahata_mikado_options()->getOptionValue('menu_area_background_transparency_header_standard_extended') === '0';
		}
        ...
        if($logoAreaTransparent || $menuAreaTransparent) {
            if($logoAreaTransparent) {
                ...
                if(anahata_mikado_is_top_bar_enabled() && anahata_mikado_is_top_bar_completely_transparent()) {
                    $transparencyHeight += anahata_mikado_get_top_bar_height();
                }
            }
