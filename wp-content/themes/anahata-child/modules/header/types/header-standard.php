...
class HeaderStandard extends HeaderType {
	...
	public function __construct() {
		...
		if(!is_admin()) {
			...
			$menuAreaHeight       = anahata_mikado_filter_px(anahata_mikado_options()->getOptionValue('menu_area_height_header_standard'));
	...
	public function headerPerPageStyles($style) {
        ...
        $disable_border = anahata_mikado_get_meta_field_intersect('menu_area_border_header_standard',$id) == 'no';
        $disable_grid_border = anahata_mikado_get_meta_field_intersect('menu_area_in_grid_border_header_standard',$id) == 'no';
	...
	public function loadTemplate($parameters = array()) {
		...
		$parameters['menu_area_in_grid'] = anahata_mikado_get_meta_field_intersect('menu_area_in_grid_header_standard',$id) == 'yes' ? true : false;

		$parameters = apply_filters('anahata_mikado_header_standard_parameters', $parameters);
	...
	public function calculateHeightOfTransparency() {
		...
		} elseif(anahata_mikado_options()->getOptionValue('menu_area_background_color_header_standard') == '') {
			$menuAreaTransparent = anahata_mikado_options()->getOptionValue('menu_area_grid_background_color_header_standard') !== '' &&
			                       anahata_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_standard') !== '1';
		} else {
			$menuAreaTransparent = anahata_mikado_options()->getOptionValue('menu_area_background_color_header_standard') !== '' &&
			                       anahata_mikado_options()->getOptionValue('menu_area_background_transparency_header_standard') !== '1';
		}
	...
	public function calculateHeightOfCompleteTransparency() {
		...
		if(get_post_meta($id, 'mkd_menu_area_background_color_header_standard_meta', true) !== '') {
			...
			$menuAreaTransparent = anahata_mikado_options()->getOptionValue('menu_area_grid_background_color_header_standard') !== '' &&
			                       anahata_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_standard') === '0';
		} else {
			$menuAreaTransparent = anahata_mikado_options()->getOptionValue('menu_area_background_color_header_standard') !== '' &&
			                       anahata_mikado_options()->getOptionValue('menu_area_background_transparency_header_standard') === '0';
		}
