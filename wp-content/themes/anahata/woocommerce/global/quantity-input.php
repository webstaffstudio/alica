...
if ( $max_value && $min_value === $max_value ) {
    ...
    $label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'anahata' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'anahata' );	?>
	<div class="quantity mkd-quantity-buttons">
		...
		<input
                ...
                title="<?php echo esc_attr_x('Qty', 'Product quantity input tooltip', 'anahata') ?>"
