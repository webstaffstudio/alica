...
if ( ! empty( $product_tabs ) ) : ?>
	...
	<div class="mkd-tabs woocommerce-tabs wc-tabs-wrapper mkd-horizontal">
		...
		<?php foreach ( $product_tabs as $key => $product_tab ) : ?>
			<div class="mkd-tab-container woocommerce-Tabs-panel woocommerce-Tabs-panel--<?php echo esc_attr( $key ); ?> panel entry-content wc-tab" id="tab-<?php echo esc_attr( $key ); ?>" role="tabpanel" aria-labelledby="tab-title-<?php echo esc_attr( $key ); ?>">
