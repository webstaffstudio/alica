...
class HeaderCentered extends HeaderType {
	...
	public function __construct() {
		...
		if(!is_admin()) {
            ...
            $logoAreaHeight       = anahata_mikado_filter_px(anahata_mikado_options()->getOptionValue('logo_area_height_header_centered'));
            $this->logoAreaHeight = $logoAreaHeight !== '' ? intval($logoAreaHeight) : 155;

			$menuAreaHeight       = anahata_mikado_filter_px(anahata_mikado_options()->getOptionValue('menu_area_height_header_centered'));
	...
	public function headerPerPageStyles($style) {
        ...
        $disable_logo_border = anahata_mikado_get_meta_field_intersect('logo_area_border_header_centered',$id) == 'no';
        $disable_logo_grid_border = anahata_mikado_get_meta_field_intersect('logo_area_in_grid_border_header_centered',$id) == 'no';

        $disable_menu_border = anahata_mikado_get_meta_field_intersect('menu_area_border_header_centered',$id) == 'no';
        $disable_menu_grid_border = anahata_mikado_get_meta_field_intersect('menu_area_in_grid_border_header_centered',$id) == 'no';
	...
	public function loadTemplate($parameters = array()) {
        ...
        $parameters['logo_area_in_grid'] = anahata_mikado_get_meta_field_intersect('logo_area_in_grid_header_centered',$id) == 'yes' ? true : false;
        $parameters['menu_area_in_grid'] = anahata_mikado_get_meta_field_intersect('menu_area_in_grid_header_centered',$id) == 'yes' ? true : false;

		$parameters = apply_filters('anahata_mikado_header_centered_parameters', $parameters);
	...
	public function calculateHeightOfTransparency() {
        ...
        } elseif(anahata_mikado_options()->getOptionValue('logo_area_background_color_header_centered') == '') {
            $logoAreaTransparent = anahata_mikado_options()->getOptionValue('logo_area_grid_background_color_header_centered') !== '' &&
                anahata_mikado_options()->getOptionValue('logo_area_grid_background_transparency_header_centered') !== '1';
        } else {
            $logoAreaTransparent = anahata_mikado_options()->getOptionValue('logo_area_background_color_header_centered') !== '' &&
                anahata_mikado_options()->getOptionValue('logo_area_background_transparency_header_centered') !== '1';
        }
		...
		} elseif(anahata_mikado_options()->getOptionValue('menu_area_background_color_header_centered') == '') {
			$menuAreaTransparent = anahata_mikado_options()->getOptionValue('menu_area_grid_background_color_header_centered') !== '' &&
			                       anahata_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_centered') !== '1';
		} else {
			$menuAreaTransparent = anahata_mikado_options()->getOptionValue('menu_area_background_color_header_centered') !== '' &&
			                       anahata_mikado_options()->getOptionValue('menu_area_background_transparency_header_centered') !== '1';
		}
	...
	public function calculateHeightOfCompleteTransparency() {
        ...
        if(get_post_meta($id, 'mkd_logo_area_background_color_header_centered_meta', true) !== '') {
            ...
            $logoAreaTransparent = anahata_mikado_options()->getOptionValue('logo_area_grid_background_color_header_centered') !== '' &&
                anahata_mikado_options()->getOptionValue('logo_area_grid_background_transparency_header_centered') === '0';
        } else {
            $logoAreaTransparent = anahata_mikado_options()->getOptionValue('logo_area_background_color_header_centered') !== '' &&
                anahata_mikado_options()->getOptionValue('logo_area_background_transparency_header_centered') === '0';
        }
		...
		if(get_post_meta($id, 'mkd_menu_area_background_color_header_centered_meta', true) !== '') {
			...
			$menuAreaTransparent = anahata_mikado_options()->getOptionValue('menu_area_grid_background_color_header_centered') !== '' &&
			                       anahata_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_centered') === '0';
		} else {
			$menuAreaTransparent = anahata_mikado_options()->getOptionValue('menu_area_background_color_header_centered') !== '' &&
			                       anahata_mikado_options()->getOptionValue('menu_area_background_transparency_header_centered') === '0';
		}
