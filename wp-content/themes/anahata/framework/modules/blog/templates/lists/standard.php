<div class="mkd-blog-holder mkd-blog-type-standard <?php echo esc_attr($blog_classes) ?>" data-blog-type="<?php echo esc_attr($blog_type) ?>" <?php echo esc_attr(anahata_mikado_set_blog_holder_data_params()); ?> >
    <?php
