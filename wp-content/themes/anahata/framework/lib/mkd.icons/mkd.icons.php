...
/*
  Class: AnahataMikadoIconCollections
...
class AnahataMikadoIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new AnahataMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new AnahataMikadoIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new AnahataMikadoIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new AnahataMikadoLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('linear_icons', new AnahataMikadoLinearIcons('Linear Icons', 'linear_icon'));
        $this->addIconCollection('simple_line_icons', new AnahataMikadoSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new AnahataMikadoDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getSocialVCParamsArray($iconPackDependency = array(), $iconCollectionPrefix = "", $emptyIconPack = false, $exclude = '') {
        ...
        $iconPackParams = array(
            'type'        => 'dropdown',
            'heading'     => esc_html__('Icon pack', 'anahata'),
        ...
        if(is_array($iconCollections) && count($iconCollections)) {
            foreach($iconCollections as $key => $collection) {
                $iconSetParams[] = array(
                    'type'        => 'dropdown',
                    'class'       => '',
                    'heading'     => esc_html__('Icon', 'anahata'),
                    'param_name'  => $iconCollectionPrefix.$collection->param,
    ...
    public function getWidgetIconParams() {
        ...
        $iconPackParams[] = array(
            'type'    => 'dropdown',
            'title'   => esc_html__('Icon Pack', 'anahata'),
            'name'    => 'icon_pack',
            'options' => array(
                'font_awesome'      => esc_html__('Font Awesome', 'anahata'),
                'font_elegant'      => esc_html__('Font Elegant', 'anahata'),
                'ion_icons'         => esc_html__('Ion Icons', 'anahata'),
                'simple_line_icons' => esc_html__('Simple Line Icons', 'anahata')
            )
        );
    ...
    public function getIconCollectionIcons(iAnahataMikadoIconCollection $collection) {
    ...
    public function getSearchIcon($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
				...
				echo anahata_mikado_get_module_part($iconsObject->getSearchIcon());
            }
    ...
    public function getSearchClose($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
				...
				echo anahata_mikado_get_module_part($iconsObject->getSearchClose());
            }
    ...
    public function getSearchIconValue($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
			echo anahata_mikado_get_module_part($iconsObject->getSearchIconValue());
    ...
    public function getMenuSideIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
			echo anahata_mikado_get_module_part($iconsObject->getMenuSideIcon());
    ...
    public function getBackToTopIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
			echo anahata_mikado_get_module_part($iconsObject->getBackToTopIcon());
    ...
    public function getMobileMenuIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
				...
				echo anahata_mikado_get_module_part($iconsObject->getMobileMenuIcon());
            }
        }
    ...
    public function getQuoteIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return == true) {
				...
				echo anahata_mikado_get_module_part($iconsObject->getQuoteIcon());
            }
...
$anahata_IconCollections = AnahataMikadoIconCollections::get_instance();