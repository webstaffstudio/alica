...
foreach($sizes as $size) {
	if(!empty($$size)) {
		$data_attr['data-'.$size] = anahata_mikado_filter_px($$size);
	}
}

$data_attr['data-original-height'] = anahata_mikado_filter_px($height);

?>
<div <?php echo anahata_mikado_get_inline_attrs($data_attr); ?> class="<?php echo esc_attr(trim($css_class)); ?>" <?php echo esc_attr($inline_css); ?> >
